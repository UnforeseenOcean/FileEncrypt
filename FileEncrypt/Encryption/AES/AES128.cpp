...
void Encryption::AES128::Cipher(BYTE srcBytes[16], const UINT32 srcExpandedKey[44]) {
...
void Encryption::AES128::KeyExpansion(const BYTE srcKey[16], UINT32 dstExpandedKey[44]) {
